...
def generate_keypair() -> None:
    ...
    try:
        ...
        if save == "y":
            ...
            _save_output(output, "ecdh_keypair.pem")
    ...
    try:
        ...
        if save == "y":
            ...
            output = (
                ...
                f"\n*Note: In practice, this secret MUST be passed through a KDF (like HKDF) before use as an encryption key."
            )
...
def show_how_ecdh_works() -> None:
  ...
  Security:
    ...
    Logarithm Problem (ECDLP), which is computationally infeasible.
    """)
